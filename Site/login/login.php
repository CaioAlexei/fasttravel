      ...
      <div class="container">
          ...
          <div class="welcome text-left">
            ...
            <form method="post" action="login.php" >
              ...
              <button type="submit" class="btn btn-dark" name="login">Entrar</button> <a class="btn btn-dark" data-toggle="collapse" href="../cadastro/cadastro.php" role="button" aria-expanded="false" aria-controls="collapseExample">
                    Cadastrar
                  </a>
                <?php
