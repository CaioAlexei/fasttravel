...
<body>
        ...
        <li class="list-group-item d-flex justify-content-between lh-condensed">
             <div class="profile-menu">
                 ...
                 <?php
                     ...
                     if(($perfil_img != null) && ($perfil_img != "0")){
                     ...
                     elseif($perfil_img == "0"){
                         echo "<img src='imagem_perfil/interrogacao.png' >";
      	                 
                     }
                     
                     elseif($perfil_img == null){
                          echo "<img src='imagem_perfil/interrogacao.png' >";
                ...
                <ul>
                    ...
                    <?php if($permi_tu != 0){
    echo"<li> <a href='../../turismologo/passeio/index/passeioframe.php'>Passeios</a></li>";
    
}
                    else{
                        echo"Aguarde sua permissão!";
                    }?>
    ...
    <div class="col-md-8 order-md-1">
      <h2 class="mb-3">Informações do Turismólogo</h2>
      <form class="needs-validation" enctype="multipart/form-data" method="post" action="perfilturis.php">
        <div class="row">
        ...
        <div class="mb-3">
          ...
          <div class="col-md-3 mb-3">
            ...
            <div class="col">
                <form enctype="multipart/form-data"  method="post" action="perfilturis.php">
