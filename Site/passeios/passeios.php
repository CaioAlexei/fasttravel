...
$busca = mysqli_real_escape_string($con,$_POST['busca']);

$pagina = (isset($_GET['pagina']))? $_GET['pagina'] : 1;


$result_passeio = "SELECT * FROM passeios WHERE local = '$busca'";
...
$result_passeio = "SELECT * FROM passeios WHERE local = '$busca' limit $incio, $quantidade_pg";
$resultado_passeio = mysqli_query($con, $result_passeio);
$total_passeio = mysqli_num_rows($resultado_passeio);
?>
<!DOCTYPE html>
